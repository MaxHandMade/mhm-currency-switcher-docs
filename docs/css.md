...
These are all front-end classes. The variation-pricing panel you see in the product editor is a separate, admin-only screen and isn't meant to be restyled with CSS.
