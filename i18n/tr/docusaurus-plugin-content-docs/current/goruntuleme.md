...
Önbellek uyumluluğu modu açıkken (varsayılan durum — bkz. [Gelişmiş Ayarlar](/docs/advanced-settings)) ziyaretçi sepet, ödeme ya da hesap sayfası dışındaki bir sayfada dönüştürücüden para birimi değiştirdiğinde sayfa **yeniden yüklenmez**: eklenti çerezi yazar, sayfadaki fiyatları olduğu yerde dönüştürür ve mini sepeti tazeler. Sepet, ödeme ya da hesap sayfasında, bir tema ya da eklentinin WooCommerce'in sepet sabitini tanımladığı bir sayfada (bkz. [SSS](/docs/faq)), oturum açmış bir ziyaretçide veya önbellek uyumluluğu kapatıldığında sayfa eskisi gibi yeniden yüklenir.
